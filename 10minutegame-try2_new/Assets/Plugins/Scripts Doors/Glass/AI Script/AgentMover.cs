...
public class AgentMover : MonoBehaviour
{
    ...
    {
        _onNavMeshLink = true;
        Unity.AI.Navigation.NavMeshLink link = (Unity.AI.Navigation.NavMeshLink)_Agent.navMeshOwner;
        Spline spline = link.GetComponentInChildren<Spline>();

        PerformJump(link, spline);
    }

    private void PerformJump(Unity.AI.Navigation.NavMeshLink link, Spline spline)
    {
    ...
    private bool CheckIfJumpingFromEndToStart(Unity.AI.Navigation.NavMeshLink link)
    {
