...
namespace SplineMesh {
    ...
    public class ExampleSower : MonoBehaviour {
        ...
        public bool isSampleRotation = false;
        ...
        public void Sow() {
            ...
            while (distance <= spline.Length) {
                ...
                go.transform.localScale = (Vector3.one * scale) + (scaleVector * rangedScale);
                ...
                if (isRandomYaw)
                {
                    go.transform.Rotate(UnityEngine.Random.Range(50, 130), go.transform.rotation.y + UnityEngine.Random.Range(-25, 25), go.transform.rotation.z + UnityEngine.Random.Range(-20, 20));
                }
